...
public class EnsembleSynthesizers {
    ...
    public static final DeferredHolder<InstrumentSynthesizerType<?>, InstrumentSynthesizerType<SoundEventSynthesizer>> SOUND_EVENT = REGISTRY.register("sound_event", () -> InstrumentSynthesizerType.of(SoundEventSynthesizer.CODEC));
}
